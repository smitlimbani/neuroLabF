...
export class ListGenerationComponent implements OnInit {
  ...
  async generateNav(){
    ...
    //   {"id":6,"vials":null,"code":"myo","name":"myo","rate":1550.0,"testCategory":"BLOT","groupSize":2,"lockedCounter":0,"active":true}];
